...
CONTAINS
   ...
   SUBROUTINE rk4(n, xin, xout, vin, vout, dt)
      ...
      DO k = 1, idim ! number of dimensions
         DO i = 1, n ! number of bodies to be updated
            DO j = 1, n ! number of bodies influencing the to-be-updated body
               IF (i .NE. j) THEN
      ...
      DO k = 1, idim ! for every dimension
         DO i = 1, n ! for every planet
